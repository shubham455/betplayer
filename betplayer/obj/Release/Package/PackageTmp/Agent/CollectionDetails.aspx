<%@ Page Language="C#" MasterPageFile="~/Agent/DashBoard.Master" AutoEventWireup="true" CodeBehind="CollectionDetails.aspx.cs" Inherits="betplayer.Agent.CollectionDetails" %>
                                            ...
                                            <tr bgcolor="#FFFFFF" class="odd">
                                                ...
                                                <td align="left" class=" ">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="CollectionDetailsModify.aspx?id=<%: row["ClientCollectionNameID"] %>"><i class="icon-pencil"></i>Edit</a></li>
