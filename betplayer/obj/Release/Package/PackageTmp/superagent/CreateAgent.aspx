            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="AgentDetails.aspx">Agent Details</a><span class="divider">&nbsp;</span></li>
                                            ...
                                            <table width="850" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td align="left" valign="middle">
                                                            <asp:TextBox CssClass="textbox" ID="txtAgentShare" OnTextChanged="txtAgentShare_TextChanged" Text="0" AutoPostBack="true" runat="server"/>
                                                    ...
                                                    <tr id="divSessionCommission">
                                                        ...
                                                        <td align="left">
                                                            <input name="SessionCommissionClient" runat="server" type="text" class="textbox" id="SessionCommissionAgent" onblur="showCustomer(this.value)" value="0" required></td>
                                                        <td align="left">
                                                            <input name="SessionCommissionClient" runat="server" type="text" class="textbox" id="Text2" onblur="showCustomer(this.value)" readonly="" value="0" required></td>
