<%@ Page Language="C#" MasterPageFile="~/admin/DashBoard.Master" AutoEventWireup="true" CodeBehind="AgentLedger.aspx.cs" Inherits="betplayer.admin.Agent_Ledger" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Agent Ledger
  <small></small></h3>
                    <ul class="breadcrumb">
