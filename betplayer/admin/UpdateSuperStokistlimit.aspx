<%@ Page Language="C#" MasterPageFile="~/admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="UpdateSuperStokistlimit.aspx.cs" Inherits="betplayer.admin.UpdateSuperStokistlimit" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">SuperAgent Limit</h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Master Details <span class="divider">&nbsp;</span> </li>
                        <li>SuperAgent Limit<span class="divider">&nbsp;</span></li>
                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>SuperAgent Limit</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr bgcolor="#E9F3FD" class="TableHeading">
                                        ...
                                        <td align="left" valign="middle" bgcolor="#FFFFFF" class="TableHeading">
                                            <input runat="server" name="SuperAgentLimit" type="text" id="SuperAgentLimit" style="text-align: right" value=""></td>
