<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/Dashboard.Master" CodeBehind="ModifySuperstockist.aspx.cs" Inherits="betplayer.admin.ModifySuperSuperstockist" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Create New Superstockist</h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Master Details <span class="divider">&nbsp;</span> </li>
                        <li><a href="SuperstockistDetails.aspx">Superstockist Details</a><span class="divider">&nbsp;</span></li>
                        <li>Create New Superstockist<span class="divider">&nbsp;</span></li>
                        <li><a href="SuperstockistDetails.aspx"><span style="color: #00F;"><strong>Back</strong></span></a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>Modify Superstockist</h4>
                                            ...
                                            <table width="850" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="30" align="left" valign="middle" class="welcome">Superstockist Limit</td>
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox CssClass="textbox" ID="txtSuperstockistlimit" runat="server" /></td>
                                                        <td align="left" valign="middle">&nbsp;</td>
                                                    </tr>

                                                    <tr>
                                                        <td align="left" class="welcome">&nbsp;</td>
                                                        <td height="30" align="left" valign="middle" class="welcome">Superstockist Share %</td>
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox CssClass="textbox" ID="txtSuperstockistShare" runat="server" /></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="30" align="left" valign="middle" class="welcome"><strong>Superstockist Commission Percentage</strong></td>
                                                    ...
                                                    <tr id="divMatchCommission">
                                                        ...
                                                        <td align="left">
                                                            <input runat="server" name="MatchCommissionSuperstockist" type="text" class="textbox" id="MatchCommissionSuperstockist" onblur="showCustomer(this.value)" value="0"></td>
                                                    ...
                                                    <tr id="divSessionCommission">
                                                        ...
                                                        <td align="left">
                                                            <input name="SessionCommissionSuperstockist" runat="server" type="text" class="textbox" id="SessionCommissionSuperstockist" onblur="showCustomer(this.value)" value="0"></td>
