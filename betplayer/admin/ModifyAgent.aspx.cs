...
namespace betplayer.admin
{
	public partial class ModifyAgent : System.Web.UI.Page
	{
		protected void Page_Load(object sender, EventArgs e)
		{
            ...
            if (!IsPostBack)
            {
                ...
                using (MySqlConnection cn = new MySqlConnection(CN))
                {
                    ...
                    txtMobileApp.Text = dt.Rows[0]["mobapp"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                string s = "Update Agentmaster set ContactNo= @ContactNo,Password=@Password,Agentlimit=@Agentlimit,AgentShare=@Agentshare,MobApp = @MobileApp,SessionCommisionType=@SessionType,MatchCommision= @MatchCommision,SessionCommision =@SessionCommision where AgentID = '" + Id + "' ";
                MySqlCommand cmd = new MySqlCommand(s, cn);
