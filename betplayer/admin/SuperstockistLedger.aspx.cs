...
namespace betplayer.admin
{
    public partial class AgentLedger : System.Web.UI.Page
    {
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                string s = "Insert Into SuperstockistCollectionMaster (SuperstockistID,CollectionType,Date,Amount,PaynmentType,Remark,AdminID) values(@SuperstockistID,@CollectionType,@Date,@Amount,@PaynmentType,@Remark,@AdminID)";
                MySqlCommand cmd = new MySqlCommand(s, cn);
