<%@ Page Language="C#" MasterPageFile="~/admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="DeleteBets.aspx.cs" Inherits="betplayer.admin.DeleteBets" %>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                                            ...
                                            <table width="850" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox CssClass="textbox" ID="txtRate" runat="server" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="welcome">&nbsp;</td>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox runat="server" CssClass="textbox" ID="txtAmount" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="welcome">&nbsp;</td>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox runat="server" CssClass="textbox" ID="txtMode" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox CssClass="textbox" ID="txtTeam" runat="server" ReadOnly="true" /></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox CssClass="textbox" ID="txtClient" runat="server" ReadOnly="true" /></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox CssClass="textbox" ID="txtPosition1" runat="server" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox CssClass="textbox" ID="txtposition2" runat="server" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" class="welcome">&nbsp;</td>
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox CssClass="textbox" ID="txtDate" runat="server" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="form-actions">
                                <asp:Button ID="btnSave" CssClass="btn btn-success" runat="server" OnClientClick="return DeleteItem()" OnClick="btnUpdate_Click" Text="Save" />
