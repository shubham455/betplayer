<%@ Page Language="C#" MasterPageFile="~/admin/DashBoard.Master" AutoEventWireup="true" CodeBehind="MatchSessionPlusMinusDisplay.aspx.cs" Inherits="betplayer.admin.Test" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td height="25" colspan="2" align="left" valign="middle">
                                                <%foreach (betplayer.MatchSessionPlusMinus.Superstockist SuperStockist in admin.SuperstockistsData)
                                                    { %>
