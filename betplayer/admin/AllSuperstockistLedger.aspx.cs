...
{
    public partial class AllSuperAgentLedger : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Receive.Columns.Add(new DataColumn("SuperstockistName"));
            ...
            Give = new DataTable();
            Give.Columns.Add(new DataColumn("SuperstockistName"));
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string SelectSuperstockist = "Select SuperstockistID,Name,ContactNo From SuperstockistMaster";
                MySqlCommand SelectSuperstockistcmd = new MySqlCommand(SelectSuperstockist, cn);
                MySqlDataAdapter SelectSuperstockistadp = new MySqlDataAdapter(SelectSuperstockistcmd);
                DataTable SelectSuperstockistdt = new DataTable();
                SelectSuperstockistadp.Fill(SelectSuperstockistdt);


                for (int i = 0; i < SelectSuperstockistdt.Rows.Count; i++)
                {
                    int SuperstockistID = Convert.ToInt16(SelectSuperstockistdt.Rows[i]["SuperstockistID"]);

                    string s = "Select * From SuperstockistLedger where SuperstockistID = '" + SuperstockistID + "'";
                    ...
                    string CollectionAmount = "Select * From SuperstockistCollectionmaster where SuperstockistID = '" + SuperstockistID + "'";
                    ...
                    if (TotalbalanceAmount1 < 0)
                    {
                        ...
                        string Name = (SelectSuperstockistdt.Rows[i]["Name"]).ToString();
                        string ContactNo = (SelectSuperstockistdt.Rows[i]["ContactNo"]).ToString();

                        Giverow["SuperstockistName"] = SuperstockistID + "" + Name;
                    ...
                    else if (TotalbalanceAmount1 > 0)
                    {
                        ...
                        Receiverow["SuperstockistName"] = SuperstockistID + "" + Name;
