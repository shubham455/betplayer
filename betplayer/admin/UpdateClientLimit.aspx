<%@ Page Language="C#" MasterPageFile="~/admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="UpdateClientLimit.aspx.cs" Inherits="betplayer.admin.UpdateClientLimit" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
                ...
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <a id="btnUpdate" class="btn btn-success" onclick="updateLimits()">Update Limits
                            </a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="ClientDetails.aspx" class="btn">Cancel</a>
    ...
    <script>
        ...
        function updateLimits() {
            ...
            for (var i = 2, row; i < (table.rows.length); i++) {
