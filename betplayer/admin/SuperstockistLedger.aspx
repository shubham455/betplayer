<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/admin/Dashboard.Master" CodeBehind="SuperstockistLedger.aspx.cs" Inherits="betplayer.admin.AgentLedger" %>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td height="30">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" InitialValue="0" ControlToValidate="dropdownsuperstockist" ErrorMessage="**"></asp:RequiredFieldValidator>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" InitialValue="0" ControlToValidate="dropdowncollection" ErrorMessage="**"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"  ControlToValidate="Amount" ErrorMessage="**"></asp:RequiredFieldValidator>
