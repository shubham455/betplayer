...
namespace betplayer.admin
{
    public partial class My_Ledger : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                string s = "select matches.DateTime,matches.TeamA,matches.TeamB, adminledger.Amount,adminledger.Dabit,adminledger.credit,adminledger.remark from adminledger inner join matches on adminledger.matchID = matches.apiID  Where adminledger.AdminID = '" + Session["AdminID"] + "' ";
