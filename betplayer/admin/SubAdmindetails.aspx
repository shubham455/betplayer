<%@ Page Language="C#" MasterPageFile="~/admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="SubAdmindetails.aspx.cs" Inherits="betplayer.admin.SubAdmindetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">SubAdmin Details  <small>Display SubAdmin Details</small> </h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Master Details <span class="divider">&nbsp;</span> </li>
                        <li>SubAdmin Details<span class="divider">&nbsp;</span></li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>SubAdmin Details</h4>
                                        ...
                                        <table width="100%" class="table table-striped table-hover table-bordered dataTable" id="sample_1" aria-describedby="sample_1_info" style="width: 100%;">
                                            <thead>
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <th width="60" align="left" class="sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="Contact: activate to sort column ascending" style="width: 73px;">Status</th>
                                                ...
                                                <tr bgcolor="#FFFFFF" class="even">
                                                    <td align="center" class="  sorting_1">
                                                        <div class="checker" id="uniform-2">
                                                            <span>
                                                                <input type="checkbox" class="checkboxes" name="checkbox" id="check" onclick="ChangesInStatus('<%:row["SubAdminID"] %>" value="<%:row["SubAdminID"] %>" style="opacity: 0;"></span>
                                                        </div>
                                                    </td>
                                                    <td align="left" class=" ">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="ModifySubAdmin.aspx?id=<%:row["SubAdminID"] %>"><i class="icon-pencil"></i>Edit</a></li>
                                                                <li><a onclick="Delete('<%:row["SubAdminID"] %>');"><i class="icon-trash"></i>Delete</a></li>
                                                                <li><a onclick="ChangesInStatus('<%:row["SubAdminID"] %>');"><i class="icon-trash"></i>Active/Inactive</a></li>
                                                                <li><a href="javascript:SendLoginDetails('118');"><i class="icon-film"></i>Send Mobile Login Details</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                    <td height="20" align="left" class="FontText "><%:row["SubAdminID"] %></td>
    ...
    <script>
        function Delete(userId) {
            ...
            fetch('/Admin/Deletesubadmin.ashx', {
                method: 'POST',
                headers: {
    ...
    <script>
        function ChangesInStatus(userId) {
            ...
            fetch('/Admin/Changesubadminstatus.ashx', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
                },
