<%@ Page Language="C#" MasterPageFile="~/Admin/Dashboard.Master" CodeBehind="SuperStockistDetails.aspx.cs" Inherits="betplayer.Admin.SuperStokistDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">SuperStokist Details  <small>Create, Modify, Delete and Display SuperStokist Details</small> </h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Master Details <span class="divider">&nbsp;</span> </li>
                        <li>SuperStokist Details<span class="divider">&nbsp;</span></li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>SuperStokist Details</h4>
                        ...
                        <div class="widget-body form">
                            <div class="portlet-body">
                                <div class="clearfix">
                                    ...
                                    <a href="CreateSuperStockist.aspx">
                                ...
                                <table width="100%" class="table table-striped table-hover table-bordered dataTable" id="sample_1" aria-describedby="sample_1_info" style="width: 100%;">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th align="left" rowspan="1" colspan="1">&nbsp;</th>
                                            <th align="left" rowspan="1" colspan="1">&nbsp;</th>
                                            <th colspan="3" align="center" valign="middle" style="text-align: center; vertical-align: middle;" rowspan="1">SuperStokist Commission %</th>
                          ...
                          "
                                            ...
                                            <th align="right" style="text-align: center; width: 51px;" class="sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-label="SuperStokist : activate to sort column ascending">SuperStokist </th>
                                        ...
                                        <tr class="odd">
                                            <td align="center" class="  sorting_1">
                                                <div class="checker" id="uniform-1">
                                                    <span>
                                                        <input type="checkbox" class="checkboxes" name="checkbox" id="check" onclick="ChangesInStatus('<%:row["SuperStockistID"] %>" value="<%:row["SuperStockistID"] %>" style="opacity: 0;"></span>
                                                </div>
                                            </td>
                                            <td align="left" class=" ">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="ModifySuperStockist.aspx?id=<%:row["SuperStockistID"] %>"><i class="icon-pencil"></i>Edit</a></li>
                                                        ...
                                                        <li><a onclick="SendLoginDetails('<%:row["SuperStockistID"] %>');"><i class="icon-film"></i>Send Login Details</a></li>
                                                    </ul>
                                                </div>
                                            </td>
    ...
    <script>
        function SendLoginDetails(userId) {
            ...
            fetch('/Admin/SendSuperstockistDetails.ashx', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
                },
