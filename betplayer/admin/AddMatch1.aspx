<%@ Page Language="C#" MasterPageFile="~/admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="AddMatch1.aspx.cs" Inherits="betplayer.admin.AddMatch1" %>
					...
					<div class="span12">
					  ...
					  Sport's Betting</h3>
						<ul class="breadcrumb">
							...
							<li><a href="AddMatch.aspx">Add Matches</a><span class="divider">&nbsp;</span></li>
                ...
                <div class="row-fluid circle-state-overview">
                    <div style="float:left;padding-left:20px;padding-right:20px;">
                        <div class="circle-wrap">
                            <a href="AddMatch.aspx">
                                <div class="stats-circle turquoise-color">
                                    <i class="icon-user"></i>
                                </div>
                            <strong><p style="color:#4CC5CD;">Add Matches</p></strong>
                            </a>
                        </div>
                    </div>
