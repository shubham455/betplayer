<%@ Page Language="C#" MasterPageFile="~/admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="UpdatedRunnerBets.aspx.cs" Inherits="betplayer.admin.UpdatedBets" %>
                               ...
                               <table width="100%" class="table table-striped table-hover table-bordered" id="MatchBet">
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: right;" class="TableHeading"><strong>Position1</strong></td>
                                        <td style="text-align: right;" class="TableHeading"><strong>Position2</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td height="25" align="left" class="TableHeading"><strong><%: row["UpdateRunnerBetsID"] %></strong></td>
