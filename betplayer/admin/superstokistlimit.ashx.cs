...
{
    /// <summary>
    /// Summary description for superstokistlimit
    /// </summary>
    public class superstokistlimit : IHttpHandler,IRequiresSessionState
    {
            ...
            try
            {
                ...
                using (MySqlConnection cn = new MySqlConnection(CN))
                {
                    ...
                    foreach (Object client in clientValues)
                    {
                        ...
                        string updatelimit = "Update superstockistmaster set  Fixlimit = '" + fixlimit + "',CurrentLimit= '" + clientLimit + "'  Where SuperStockistID = '" + clientID + "'";
