    ...
    public partial class CompanymatchSessionPlusminusDisplay : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string SuperAgent = "Select SuperAgentID,Code,Name From SuperAgentMaster where Createdby = '" + Session["AdminCode"] + "'";
                ...
                for (int b = 0; b < SuperAgentdt.Rows.Count; b++)
                {
                    ...
                    AgentDataList.Add(FetchClientData(SuperAgentcode, SuperAgentID));
        ...
        public DataTable FetchClientData(string SuperAgentcode, int SuperagentID)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string Agent = "Select AgentID,Code,Name From AgentMaster where Createdby = '" + SuperAgentcode + "'";
