<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="betplayer.Super_Agent.Homepage" %>
...
<head>
    ...
    <link href="../Agent/css/Homepage/bootstrap.min.css" rel="stylesheet">
    <link href="http://fonts.googleapis.com/css?family=Cookie" rel="stylesheet" type="text/css">
    <link href="http://fonts.googleapis.com/css?family=Quicksand:300,400,700" rel="stylesheet" type="text/css">
    <link href="../Agent/css/Homepage/style.css" rel="stylesheet">
</head>
<body data-gr-c-s-loaded="true" style="">
    ...
    <section class="slider">
        <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item">
                    <img data-src="../Agent/img/Homepage/slider.jpg" alt="First slide" src="../Agent/img/Homepage/slider.jpg">
                </div>
                <div class="item active">
                    <img data-src="../Agent/img/Homepage/slider1.jpg" alt="Second slide" src="../Agent/img/Homepage/slider1.jpg">
                </div>
            </div>
    ...
    <section class="main__middle__container">
        <div class="container" style="color: #000; font-family: Verdana, Geneva, sans-serif;">
            ...
            <br>
            <div class="col-md-4">
                <img src="../Agent/img/Homepage/img1.jpg" alt="image" class="img-responsive img-rounded">
                <p>
                    <br>
                </p>
            </div>
            <div class="col-md-4">
                <img src="../Agent/img/Homepage/img2.jpg" alt="image" class="img-responsive img-rounded">
                <p>
                    <br>
                </p>
            </div>
            <div class="col-md-4">
                <img src="../Agent/img/Homepage/img3.jpg" alt="image" class="img-responsive img-rounded">
                <p>
                    <br>
                </p>
            </div>
        ...
        <div class="row grey-info-block text-center">
            <div class="container">
                ...
                <div class="col-md-6">
                    <img src="../Agent/img/Homepage/pic1.jpg" alt="image" class="img-rounded img-responsive">
                    <br>
                </div>
                <div class="col-md-6">
                    <img src="../Agent/img/Homepage/pic2.jpg" alt="image" class="img-rounded img-responsive">
                    <br>
                </div>
                <div class="clear"></div>
            </div>
    ...
    <script type="text/javascript" src="../Agent/js/Homepage/jquery.min.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="../Agent/js/Homepage/bootstrap.min.js"></script>
