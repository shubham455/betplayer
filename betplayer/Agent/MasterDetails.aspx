<%@ Page Language="C#" MasterPageFile="~/Agent/DashBoard.Master" AutoEventWireup="true" CodeBehind="MasterDetails.aspx.cs" Inherits="betplayer.Agent.MasterDetails" %>
                ...
                <div class="row-fluid circle-state-overview">
                    <div style="float:left;padding-left:20px;padding-right:20px;">
                        <div class="circle-wrap">
                            ...
                            <strong><p style="color:#4CC5CD;">Client Master</p></strong>
                            </a>
                        </div>
                    </div>
