            ...
            if (!IsPostBack)
            {
                ...
                using (MySqlConnection cn = new MySqlConnection(CN))
                {
                    ...
                    foreach (DataRow row in dt1.Rows)
                    {
                        ...
                        double Position1 = double.Parse(Position.ToString());
                    ...
                    foreach (DataRow row in dt1.Rows)
                    {
                        ...
                        double Position2 = double.Parse(Position.ToString());
                        row["Position2"] = Position2;
                        k++;
