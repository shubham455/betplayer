<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="ModifyAgent.aspx.cs" Inherits="betplayer.SuperStokist.ModifyAgent" %>
                                            ...
                                            <table width="850" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <asp:DropDownList ID="DropDownstatus" runat="server" CssClass="form-control" AppendDataBoundItems="true"  Width="150px">
                                                    ...
                                                    <tr id="divMatchCommission">
                                                        ...
                                                        <td align="left">
                                                            <input runat="server" name="MatchCommissionClient" type="text" class="textbox" readonly="" id="Text2" onblur="showCustomer(this.value)" value="0"></td>
                                                    ...
                                                    <tr id="divSessionCommission">
                                                        ...
                                                        <td align="left">
                                                            <input name="SessionCommissionClient" runat="server" type="text" class="textbox" readonly="" id="Text1" onblur="showCustomer(this.value)" value="0"></td>
