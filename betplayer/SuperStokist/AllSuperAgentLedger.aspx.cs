...
namespace betplayer.SuperStokist
{
    public partial class AllAgentLedger : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Receive.Columns.Add(new DataColumn("SuperAgentName"));
            ...
            Give = new DataTable();
            Give.Columns.Add(new DataColumn("SuperAgentName"));
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string SelectSuperAgent = "Select SuperAgentID,Name,ContactNo From SuperAgentMaster where CreatedBy = '" + Session["Superstockistcode"] + "'";
                ...
                {
                    int SuperAgentID = Convert.ToInt16(SelectSuperAgentdt.Rows[i]["SuperAgentID"]);
                    ...
                    for (int j = 0; j < dt.Rows.Count; j++)
                    {
                        ...
                        if (TotalbalanceAmount1 < 0)
                        {
                            ...
                            string Name = (SelectSuperAgentdt.Rows[i]["Name"]).ToString();
                            string ContactNo = (SelectSuperAgentdt.Rows[i]["ContactNo"]).ToString();

                            Giverow["SuperAgentName"] = SuperAgentID + "" + Name;
                        ...
                        else if (TotalbalanceAmount1 > 0)
                        {
                            ...
                            Receiverow["SuperAgentName"] = SuperAgentID + "" + Name;
