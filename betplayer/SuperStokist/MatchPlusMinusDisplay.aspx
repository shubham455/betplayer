<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="MatchPlusMinusDisplay.aspx.cs" Inherits="betplayer.SuperStokist.MatchPlusMinusDisplay" %>
                                                                ...
                                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" class="table table-striped table-bordered" style="padding-bottom: 100px;">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td align="right" style="text-align: right;" valign="middle"><strong></strong><%:row["MOBAppAmount"] %></td>
