...
namespace betplayer.SuperStokist
{
    ...
    {
        public MatchSessionPlusMinus.Superstockist superstockist;
        public int MatchID;

        protected void Page_Load(object sender, EventArgs e)
        {
            superstockist = new MatchSessionPlusMinus.Superstockist(Session["SuperstockistID"].ToString(), Request.QueryString["MatchID"]);
        }
    }
}
        ...
        //                string Admin = "Select * From Superstockistmaster where SuperstockistID = '" + Session["SuperstockistID"] + "'";
        ...
        //                string SuperAgent = "Select SuperAgentID,Code,Name From SuperAgentMaster where Createdby = '" + Session["Superstockistcode"] + "' order by name ASC";
        ...
        //                int Total = (int)Math.Round(TotalFinalAmount1, 0);
        //                if (declear == 1)
        //                {
        ...
        //                    string s9 = "Select * From  Superstockistledger where SuperstockistID = '" + Session["SuperstockistID"] + "' && MatchID  = '" + MatchID + "'";
        //                    MySqlCommand cmd9 = new MySqlCommand(s9, cn);
        //                    MySqlDataReader rdr = cmd9.ExecuteReader();
        //                    if (rdr.Read())
        //                    {
        //                        rdr.Close();
        //                        string s10 = "Select Amount from Superstockistledger where SuperstockistID = '" + Session["SuperstockistID"] + "' && MatchID  = '" + MatchID + "'";
        ...
        //                            string s11 = "update Superstockistledger set Amount = @Amount,Dabit =@Dabit,Credit=@Credit  where SuperstockistID = '" + Session["SuperstockistID"] + "' && MatchID = '" + MatchID + "'";
        //                            MySqlCommand cmd11 = new MySqlCommand(s11, cn);
        //                            cmd11.Parameters.AddWithValue("@Amount", Total);
        ...
        //                        cmd8.Parameters.AddWithValue("@SuperstockistID", Session["SuperstockistID"]);
        ...
        //                    row["SHR"] = SuperAgentShare1 + "%";
        //                    Decimal MobileAppAmount = 0;

        //                    string s7 = "Select MyMobAmount From SuperstockistMaster where  SuperstockistID = '" + Session["SuperstockistID"] + "'";
