        ...
        public DataTable FetchClientData(int AgentID, string AgentCode, string AgentName, int SuperAgentID, string SuperAgentCode)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    Decimal SessionCommision1 = 0, MatchCommision = 0, SuperAgentShare1 = 0;
                    ...
                    {
                         SessionCommision1 = Convert.ToDecimal(dt55.Rows[0]["SAgentSessionComm"]);
                         MatchCommision = Convert.ToDecimal(dt55.Rows[0]["SAgentMatchComm"]);
                         SuperAgentShare1 = Convert.ToDecimal(dt55.Rows[0]["SAgentShare"]);
