<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="AllSuperAgentLedger.aspx.cs" Inherits="betplayer.SuperStokist.AllAgentLedger" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">All SuperAgent Ledger</h3>
                    <ul class="breadcrumb">
                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>All SuperAgent Ledger</h4>
                                                            ...
                                                            <td width="49%" valign="top">
                                                                <table width="100%" border="0" cellspacing="2" cellpadding="0" class="table table-striped table-hover table-bordered">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td width="20%" height="25" align="left" valign="middle"><strong>SuperAgent Name</strong></td>
                                                                        ...
                                                                        <% foreach (System.Data.DataRow row in PaynmentReceiveTable.Rows)
                                                                                            { %>
                                                                        <tr bgcolor="#E9F3FD">
                                                                            <td height="25" align="left" valign="middle" bgcolor="#FFFFFF" class="FontText"><%:row["SuperAgentName"] %></td>
