<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="AllAgentLedger.aspx.cs" Inherits="betplayer.SuperStokist.AllAgentLedger" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">All Agent Ledger</h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Ledger <span class="divider">&nbsp;</span> </li>
                        <li>All Agent Ledger<span class="divider">&nbsp;</span></li>
                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>All Agent Ledger</h4>
                                                            ...
                                                            <td width="49%" valign="top">
                                                                <table width="100%" border="0" cellspacing="2" cellpadding="0" class="table table-striped table-hover table-bordered">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td width="20%" height="25" align="left" valign="middle"><strong>Agent Name</strong></td>
