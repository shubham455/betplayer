<%@ Page Language="C#" MasterPageFile="~/Superstokist/Dashboard.Master" AutoEventWireup="true" CodeBehind="Updatesuperagentlimit.aspx.cs" Inherits="betplayer.Superstokist.Updatesuperagentlimit" %>
                            ...
                            <table id="AgentLimitTable" width="100%" class="table table-striped table-hover table-bordered">
                                <tbody>
                                    ...
                                    <% int index = 2; foreach (System.Data.DataRow row in UpdateDataTable.Rows)
                                        { %>
                                    <tr bgcolor="#FFFFFF">
                                        <td height="25" align="left" class="FontText"><%: row["superAgentID"] %></td>
