<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="CompanySessionPlusMinusSelect.aspx.cs" Inherits="betplayer.SuperStokist.CompanySessionPlusMinusSelect" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td height="25" style="text-align: center; vertical-align: middle;">
                                                <asp:button id="btnshow" runat="server" class="btn btn-success" onclick="btnshow_Click" Text="Show" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
