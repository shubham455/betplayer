...
{
    public partial class CompanyPlusMinusSelect : System.Web.UI.Page
    {
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            ...
            if (select == "Match")
            {
                Response.Redirect("CompanyMatchPlusminusSelect.aspx?MatchID=" + apiId.Value);
            }
            else if (select == "Session")
            {
                Response.Redirect("CompanySessionPlusminusSelect.aspx?MatchID=" + apiId.Value);
            }
            else if (select == "Both")
            {
                Response.Redirect("CompanyMatchSessionPlusminusSelect.aspx?MatchID=" + apiId.Value);
            }
        }
    }
}