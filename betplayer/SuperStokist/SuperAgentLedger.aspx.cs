    ...
    public partial class AgentLedger : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                using (MySqlConnection cn = new MySqlConnection(CN))
                {
                    ...
                    string SuperAgentCollection = "Select * From SuperAgentCollectionName where CreatedBy = '" + Session["Superstockistcode"] + "'";
                    MySqlCommand SuperAgentCollectioncmd = new MySqlCommand(SuperAgentCollection, cn);
                    MySqlDataAdapter SuperAgentCollectionadp = new MySqlDataAdapter(SuperAgentCollectioncmd);
                    DataTable SuperAgentCollectiondt = new DataTable();
                    SuperAgentCollectionadp.Fill(SuperAgentCollectiondt);
                    dropdowncollection.DataSource = SuperAgentCollectiondt;
                    dropdowncollection.DataTextField = "Name";
                    dropdowncollection.DataValueField = "SuperAgentCollectionnameID";
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                MySqlCommand cmd = new MySqlCommand(s, cn);
                cmd.Parameters.AddWithValue("@SuperAgentID", dropdownAgent.Text);
                ...
                string SuperAgent = "select CurrentLimit From SuperAgentmaster Where SuperAgentID = '" + dropdownAgent.Text + "'";
                ...
                decimal SuperAgentcurrentlimit = Convert.ToDecimal(SuperAgentdt.Rows[0]["CurrentLimit"]);
                decimal FinalAmount = 0;
                if (PaymentType1.SelectedValue == "Payment Paid")
                {
                    FinalAmount = SuperAgentcurrentlimit - Convert.ToDecimal(Amount.Text);
                }
                ...
                string update = "Update SuperAgentmaster Set CurrentLimit = '" + FinalAmount + "' where SuperAgentID = '" + dropdownAgent.Text + "'";
                ...
                Response.Redirect("SuperAgentLedger.aspx", true);
