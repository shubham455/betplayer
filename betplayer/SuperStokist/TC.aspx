<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SuperStokist/DashBoard.Master" CodeBehind="TC.aspx.cs" Inherits="betplayer.SuperStokist.TC" %>
                        ...
                        <div class="widget-body form">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td height="30" class="typeahead"><strong>1. लोगिन करने के बाद अपना पासवर्ड बदल लें।
                                                            ...
                                                            <br>
                                                            <br>
                                                            2. प्रत्येक गेम के लिए 100/- Coins चार्ज रहेगा।<br>
                                                            <br>
                            ...
                            <div class="form-actions">
                                <a href="Dashboard.aspx">
                                    <button type="button" class="btn btn-success">NEXT =&gt; MAIN MENU</button></a>
                                <a href="../Agent/Login.aspx">
                                    <button type="button" class="btn">Log Out</button></a>
                            </div>
