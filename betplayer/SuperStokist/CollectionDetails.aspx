<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="CollectionDetails.aspx.cs" Inherits="betplayer.SuperStokist.CollectionDetails" %>
                                                ...
                                                <td align="left" class=" ">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="CollectionDetailsModify.aspx?id=<%: row["SuperAgentCollectionNameID"] %>"><i class="icon-pencil"></i>Edit</a></li>
