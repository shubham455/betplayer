<%@ Page Language="C#" MasterPageFile="~/SuperStokist/Dashboard.Master" CodeBehind="SuperAgentDetails.aspx.cs" Inherits="betplayer.SuperStokist.SuperAgentDetails" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <script>
        function ChangesInStatus(userId) {
            ...
            fetch('/Superstokist/changestatus.ashx', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
                },
     ...
     <script>
        function SendLoginDetails(userId) {
            ...
            fetch('/Superstokist/SendSuperagentDetails.ashx', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
                },
