<%@ Page Language="C#" MasterPageFile="~/SuperStokist/DashBoard.Master" AutoEventWireup="true" CodeBehind="MatchSessionPlusminusDisplay.aspx.cs" Inherits="betplayer.SuperStokist.CompanymatchSessionPlusminusDisplay" %>
                        ...
                        <div class="widget-body form">
                            ...
                            <div class="portlet-body">
                                ...
                                <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0" class="table table-striped table-bordered">
                                    <tbody>
                                        <tr>
                                            <td width="11%" height="25" align="left" valign="middle"><strong>Superstokist</strong></td>
