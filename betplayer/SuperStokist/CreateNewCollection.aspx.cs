...
namespace betplayer.SuperStokist
{
    public partial class CreateNewCollection : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                string Select = "Select * From SuperAgentCollectionName where ContactNo = @Contactno ";
                ...
                {
                    rdr.Close();
                    string s = "insert into SuperAgentCollectionName(Name,AccountNo,ContactNo,Address,GroupName,Status,CreatedBy,Date) values (@Name,@AccountNo,@ContactNo,@Address,@GroupName,@Status,@CreatedBy,@Date); SELECT LAST_INSERT_ID()";
                    ...
                    string update = "Update SuperAgentCollectionName Set Code = 'CA" + ID + "'where SuperAgentCollectionNameID = '" + ID + "' ";
        ...
        {
            Response.Redirect("~/Superstokist/Collectiondetails.aspx");
        }
    }
}