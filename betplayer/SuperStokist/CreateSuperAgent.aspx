<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SuperStokist/Dashboard.Master" CodeBehind="CreateSuperAgent.aspx.cs" Inherits="betplayer.SuperStokist.CreateSuperAgent" %>
                                        ...
                                        <td width="550">
                                            ...
                                            <table width="850" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td align="left" class="welcome">&nbsp;</td>
                                                        <td height="30" align="left" valign="middle" class="welcome">Superstockist Current Limit</td>
                                                        <td height="30" align="left" valign="middle" style="font-size: 13px; color: #F00">
                                                            <asp:TextBox CssClass="textbox" ID="txtSuperstockistlimit" runat="server"  ReadOnly="true" />
                                                        </td>
                                                        <td align="left" valign="middle" style="font-size: 13px; color: #F00"><strong>Superstockist Share %</strong></td>
                                                    </tr>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle">
                                                         ...
                                                         <td align="left">
                                                            <asp:TextBox CssClass="textbox" ID="txtSuperstockistShare" runat="server" Text="50" ReadOnly="true" /></td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
