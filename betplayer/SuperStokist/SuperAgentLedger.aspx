<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SuperStokist/DashBoard.Master" CodeBehind="SuperAgentLedger.aspx.cs" Inherits="betplayer.Superstokist.AgentLedger" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">SuperAgent Ledger
  <small></small></h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Ledger <span class="divider">&nbsp;</span> </li>
                        <li>Super Ledger<span class="divider">&nbsp;</span></li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>SuperAgent Ledger</h4>
                        ...
                        <div class="widget-body form">
                            ...
                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="2">
                                <tbody>
                                    <tr>
                                        <td width="25%" height="35"><strong>SuperAgent</strong></td>
                                    ...
                                    <tr>
                                        <td height="30">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" InitialValue="0" ControlToValidate="dropdownAgent" ErrorMessage="**"></asp:RequiredFieldValidator>
                                        ...
                                        <td>
                                           <asp:DropDownList ID="dropdowncollection" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="dropdownAgent_SelectedIndexChanged">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" InitialValue="0" ControlToValidate="dropdowncollection" ErrorMessage="**"></asp:RequiredFieldValidator>
