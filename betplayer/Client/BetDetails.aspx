...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <table style="width: 100%; border-color: #000;" border="1" cellpadding="2" cellspacing="2">
                        <tbody>
                            <% foreach (System.Data.DataRow row in MatchesDataTable.Rows)
                                { %>
                            <tr>
                                <td height="35" align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite" style="vertical-align: middle; width: 30%;">RUNNER</td>
                                <td align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite" style="vertical-align: middle; width: 10%;">MIN/MAX BET</td>
            ...
            <tr>
                <td align="left" valign="top">
                    <table style="width: 100%;" border="1" cellpadding="0" cellspacing="2">
                        <tbody>
                            <tr>
                                <td height="45" align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite10px" style="vertical-align: middle; width: 30%;">
                                    <h3>SESSION</h3>
                                </td>
                                <td height="35" align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite10px" style="vertical-align: middle; width: 10%">MIN/MAX BET</td>
                            ...
                            <tr id="row1">
                                ...
                                <td align="center" valign="middle" bgcolor="#79C1F8" class="textTeamHead" style="color: #000; position: relative;">
                            ...
                            <tr>
                                <td height="35" align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite10px" style="vertical-align: middle; width: 30%;">
                                    <h3>Fancy Meter</h3>
                                </td>
                                <td height="35" align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite10px" style="vertical-align: middle; width: 10%">MIN/MAX BET</td>
                                <td height="35" align="center" valign="middle" bgcolor="#8C8CFD" class="FontTextWhite10px" style="vertical-align: middle; width: 30%">NOT RATE</td>
                            ...
                            <tr id="row4">
                                ...
                                <td align="center" valign="middle" bgcolor="#79C1F8" class="textTeamHead" style="color: #000; position: relative;">
                                    ...
                                    <p>
                                        <input type="button" name="Not4" id="not4" value="0.00" class="ButtonNRun" onfocus="this.className='ButtonNRun_hover'" onblur="this.className='ButtonNRun'" onmouseover="this.className='ButtonNRun_hover'" onmouseout="this.className='ButtonNRun'" onclick="enableBetting(event, 'team_1', 'Session', 'Not')">
                                    </p>
                                    <p>
                                        <span class="textTeamHead" style="color: #000; text-align: center;"></span>
                                ...
                                <td align="center" valign="middle" bgcolor="#FFBAD3" class="textTeamHead" style="color: #000;">
                                    <p>
                                        <input type="button" name="Yes4" id="yes4" value="0.00" class="ButtonYRun" onfocus="this.className='ButtonYRun_hover'" onblur="this.className='ButtonYRun'" onmouseover="this.className='ButtonYRun_hover'" onmouseout="this.className='ButtonYRun'" onclick="enableBetting(event, 'team_1', 'Session', 'Yes')">
                                    </p>
                            ...
                            <tr id="row5">
                                ...
                                <td align="center" valign="middle" bgcolor="#79C1F8" class="textTeamHead" style="color: #000; position: relative;">
                                    ...
                                    <p>
                                        <input type="button" name="Not5" id="not5" value="0.00" class="ButtonNRun" onfocus="this.className='ButtonNRun_hover'" onblur="this.className='ButtonNRun'" onmouseover="this.className='ButtonNRun_hover'" onmouseout="this.className='ButtonNRun'" onclick="enableBetting(event, 'team_1', 'Session', 'Not')">
                                    </p>
                                    <p>
                                        <span class="textTeamHead" style="color: #000; text-align: center;"></span>
                                ...
                                <td align="center" valign="middle" bgcolor="#FFBAD3" class="textTeamHead" style="color: #000;">
                                    <p>
                                        <input type="button" name="Yes5" id="yes5" value="0.00" class="ButtonYRun" onfocus="this.className='ButtonYRun_hover'" onblur="this.className='ButtonYRun'" onmouseover="this.className='ButtonYRun_hover'" onmouseout="this.className='ButtonYRun'" onclick="enableBetting(event, 'team_1', 'Session', 'Yes')">
                                    </p>
                            ...
                            <tr id="row6">
                                ...
                                <td align="center" valign="middle" bgcolor="#79C1F8" class="textTeamHead" style="color: #000; position: relative;">
                                    ...
                                    <p>
                                        <input type="button" name="Not6" id="not6" value="0.00" class="ButtonNRun" onfocus="this.className='ButtonNRun_hover'" onblur="this.className='ButtonNRun'" onmouseover="this.className='ButtonNRun_hover'" onmouseout="this.className='ButtonNRun'" onclick="enableBetting(event, 'team_1', 'Session', 'Not')">
                                    </p>
                                    <p>
                                        <span class="textTeamHead" style="color: #000; text-align: center;"></span>
                                ...
                                <td align="center" valign="middle" bgcolor="#FFBAD3" class="textTeamHead" style="color: #000;">
                                    <p>
                                        <input type="button" name="Yes6" id="yes6" value="0.00" class="ButtonYRun" onfocus="this.className='ButtonYRun_hover'" onblur="this.className='ButtonYRun'" onmouseover="this.className='ButtonYRun_hover'" onmouseout="this.className='ButtonYRun'" onclick="enableBetting(event, 'team_1', 'Session', 'Yes')">
                                    </p>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <tbody>
            <tr>
                <td height="25" align="right" bgcolor="#FF9100" class="FontTextWhite10px">Session</td>
            ...
            <tr>
                ...
                <td align="right" style="background: #FFF; color: black; text-align: right; height: 25px; width: 250px" class="FontTextWhite10px "><%:row["Session"] %></td>
                <td align="center" style="background: #FFF; color: black; text-align: right;" class="FontTextWhite10px "><%:row["Rate"] %></td>
    ...
    <script src="js/Homejs/BetDetailsCustom_v4.5.js"></script>
</asp:Content>
