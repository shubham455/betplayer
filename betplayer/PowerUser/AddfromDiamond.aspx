<%@ Page Language="C#" MasterPageFile="~/PowerUser/Dashboard.Master" AutoEventWireup="true" CodeBehind="AddfromDiamond.aspx.cs" Inherits="betplayer.PowerUser.AddfromDiamond" %>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="welcome">&nbsp;</td>
                                                        <td height="30" align="left" valign="middle" class="welcome">Select Diamond Match</td>
                            ...
                            <div class="form-actions">
                                <asp:Button ID="btnsave" runat="server" ValidationGroup="vg" class="btn btn-success" Text="Add"  />
