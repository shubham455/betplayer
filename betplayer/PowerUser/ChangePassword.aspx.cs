    ...
    public partial class ChangePassword : System.Web.UI.Page
    {
        ...
        protected void btnChangepass_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    cn.Open();
                    string SELECT = "Select * from PowerUsermaster Where Password= '" + txtOldPassword.Text + "'";
                    MySqlCommand cmd = new MySqlCommand(SELECT, cn);
                    MySqlDataReader rdr = cmd.ExecuteReader();
                    if (rdr.Read())
                    {
                        rdr.Close();
                        string Update = "Update PowerUsermaster Set Password = '" + txtConfirmPassword.Text + "' where Password = '" + txtOldPassword.Text + "'";
