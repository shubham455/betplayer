<%@ Page Language="C#" MasterPageFile="~/PowerUser/Dashboard.Master" AutoEventWireup="true" CodeBehind="AddMatch.aspx.cs" Inherits="betplayer.poweruser.AddMatch" %>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox ID="txtTime" ReadOnly="true" CssClass="textbox" runat="server" /></td>
                                                        <td align="left" valign="middle">&nbsp;</td>
                                                        <td align="left" valign="middle">&nbsp;</td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td align="left" valign="middle">
                                                            <asp:TextBox ID="txtMatchType" CssClass="textbox" ReadOnly="true" runat="server" /></td>
                                                        <td align="left" valign="middle">&nbsp;</td>
                                                        <td align="left" valign="middle">&nbsp;</td>
                                                        <td align="left">&nbsp;</td>
                                                    </tr>
                            ...
                            <div class="form-actions">
                                <asp:Button ID="btnsave" runat="server" class="btn btn-success" Text="Add" OnClick="submit_Click" />
