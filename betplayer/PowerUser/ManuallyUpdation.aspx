                ...
                <tr>
                        ...
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="ScoreBoard.aspx?Matchid=<%=apiID%>&fk=<%=firebasekey %>&Type=<%=Type %>">
                    ...
                    <td>
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="MatchRates.aspx?Matchid=<%=apiID%>&fk=<%=firebasekey%>&Type=<%=Type %>">
                                        <div class="stats-circle turquoise-color">
                                            <i class="icon-user"></i>
                                        </div>
                                        <strong>
                    ...
                    <td>
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="SessionRate.aspx?Matchid=<%=apiID%>&fk=<%=firebasekey%>&Type=<%=Type %>">
                                        <div class="stats-circle turquoise-color">
                                            <i class="icon-user"></i>
                                        </div>
                                        <strong>
                    ...
                    <td>
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="SessionRateAutomatic.aspx?Matchid=<%=apiID%>&fk=<%=firebasekey%>&Type=<%=Type %>">
                                        <div class="stats-circle turquoise-color">
                                            <i class="icon-user"></i>
                                        </div>
                                        <strong>
                                            <p style="color: #4CC5CD;">Session Rates Automatic</p>
                                        </strong>
                                    </a>
                                </div>
                            </div>
                     ...
                     <td>
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="MinMax.aspx?Matchid=<%=apiID%>&fk=<%=firebasekey%>">
                                        <div class="stats-circle turquoise-color">
                                            <i class="icon-user"></i>
                                        </div>
                                        <strong>
                                            <p style="color: #4CC5CD;">Min/Max</p>
                                        </strong>
                                    </a>
                                </div>
                            </div>
                    ...
                    <td>
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="sendmatchdetails.aspx">
                                        <div class="stats-circle turquoise-color">
                                            <i class="icon-user"></i>
                                        </div>
                                        <strong>
                                            <p style="color: #4CC5CD;">Sechdule</p>
                                        </strong>
                                    </a>
                                </div>
                            </div>
                    ...
                    <td>
                        <div class="row-fluid circle-state-overview">
                            <div style="float: left; padding-left: 20px; padding-right: 20px;">
                                <div class="circle-wrap">
                                    <a href="LiveTV.aspx?Matchid=<%=apiID%>&fk=<%=firebasekey%>">
                                        <div class="stats-circle turquoise-color">
                                            <i class="icon-user"></i>
                                        </div>
                                        <strong>
                                            <p style="color: #4CC5CD;">Live Tv</p>
                                        </strong>
                                    </a>
                                </div>
                            </div>
