<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatchPlusMinusDisplay.aspx.cs" Inherits="betplayer.superagent.MatchPlusMinusDisplay" %>
        ...
        <div id="sidebar" class="nav-collapse collapse">
            ...
            <ul class="sidebar-menu">
                ...
                <span class="arrow"></span>
                    ...
                    <ul class="sub">
                        <li><a class="" href="AgentDetails.aspx">Agent Master</a></li>
                        <li><a class="" href="CollectionDetails.aspx">Collection Master</a></li>
                    </ul>
                </li>
                ...
                <span class="arrow"></span>
                    ...
                    <ul class="sub">
                        <li class="active"><a class="" href="SportsDetails.aspx">Sport's Details</a></li>
                    </ul>
                </li>
                <li class="has-sub">
                    <a href="javascript:;" class="">
                ...
                <span class="arrow"></span>
                    ...
                    <ul class="sub">
                        <li><a class="" href="My_Ledger.aspx">My Ledger</a></li>
                        <li><a class="" href="AllAgentLedger.aspx">All Agent Ledger</a></li>
                        <li><a class="" href="DebitCreditEntry.">Debit/Credit Entry</a></li>
                                                    ...
                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" class="table table-striped table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="80" align="right" valign="middle" style="text-align: right;"><strong>12,362.62        </strong></td>
                                                                <td width="80" align="right" valign="middle" style="text-align: right;"><strong>162,761.70        </strong></td>
                                                                <td width="80" align="right" valign="middle" style="text-align: right;"><strong>8,138.09        </strong></td>
                                                                <td width="80" align="right" valign="middle" style="text-align: right;"><strong>0.00        </strong></td>
                                                                <td width="80" align="right" valign="middle" style="text-align: right;"><strong>154,623.61        </strong></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" class="table table-striped table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td align="right" valign="middle" style="text-align: right;"><strong>0.00                    </strong></td>
                                                                <td align="right" valign="middle" style="text-align: right;"><strong>12,362.62                    </strong></td>
                                                                <td align="right" valign="middle" style="text-align: right;"><strong>162,761.70                    </strong></td>
                                                                <td align="right" valign="middle" style="text-align: right;"><strong>8,138.09                    </strong></td>
                                                                <td align="right" valign="middle" style="text-align: right;"><strong>0.00                    </strong></td>
                                                                <td align="right" valign="middle" style="text-align: right;"><strong>154,624.00                    </strong></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
