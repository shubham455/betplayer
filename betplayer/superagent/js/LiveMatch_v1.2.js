// Initialize Firebase
var config = {
    apiKey: "AIzaSyCG_JGXzXEwCnY_2ryNnb4OtkLUU2Q2Zq4",
    authDomain: "starbetexch2.firebaseapp.com",
    databaseURL: "https://starbetexch2.firebaseio.com",
    projectId: "starbetexch2",
    storageBucket: "",
    messagingSenderId: "1030809995429"
};
    ...
    firebase
        ...
        .on(
            ...
            function (snapshot) {
                ...
                document.getElementById("LastBall").src = "/superagent/img/LastBall/" + lastBall.event.replace(" ", "_") + ".jpg";
            }
        );
    firebase
        .database()
