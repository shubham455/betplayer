...
namespace betplayer.SubAdmin
{
    public partial class MatchSessionplusminusDisplay : System.Web.UI.Page
    {
        ...
        {
            admin = new Admin(Session["SubAdminID"].ToString(), Request.QueryString["MatchID"]);
        }
    ...
    public class Admin
    {
        ...
        public Admin(string AdminID, string MatchID)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                {
                    superStockistList.Add(new Superstockist(Superstockistdt.Rows[b]["SuperstockistID"].ToString(), MatchID));
                }
    ...
    public class Superstockist
    {
        ...
        public Superstockist(string SuperstockistID, string MatchID)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                {
                    superagentList.Add(new Superagent(SuperAgentdt.Rows[b]["SuperAgentID"].ToString(), MatchID));
                }
    ...
    public class Superagent
    {
        ...
        public Superagent(string SuperAgentID, string MatchID)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                {
                    agentlist.Add(new Agent(Agentdt.Rows[b]["AgentID"].ToString(), MatchID));
                }
    ...
    public class Agent
    {
        ...
        public Agent(string AgentID, string MatchID)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string s1 = "select clientmaster.clientID,clientmaster.Name from clientmaster inner join viewmatch on clientmaster.ClientID = viewmatch.ClientID  where MatchID = '" + MatchID + "' && CreatedBy = '" + "A" + AgentID + "'  group by ClientMaster.Name";
    ...
    public class Client
    {
        ...
        public Client(string ID, string MatchID)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string s = "select clientmaster.clientID,clientmaster.Name from clientmaster inner join viewmatch on clientmaster.ClientID = viewmatch.ClientID  where MatchID = '" + MatchID + "' && Clientmaster.ClientID = '" + ID + "'  group by ClientMaster.Name";
