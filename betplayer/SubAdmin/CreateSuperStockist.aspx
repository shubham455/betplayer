<%@ Page Language="C#"  AutoEventWireup="true" MasterPageFile="~/SubAdmin/Dashboard.Master" CodeBehind="CreateSuperStockist.aspx.cs" Inherits="betplayer.SubAdmin.CreateSuperAgent" %>
                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>Create New SuperStrokist</h4>
                                            ...
                                            <table width="850" border="0" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="30" align="left" valign="middle" class="welcome">SuperStrokist Limit</td>
                                                    ...
                                                    <tr>
                                                        <td align="left" class="welcome">&nbsp;</td>
                                                        <td height="30" align="left" valign="middle" class="welcome">SuperStrokist Share %</td>
                                                        <td align="left" valign="middle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="30" align="left" valign="middle" class="welcome"><strong>SuperStrokist Commission Percentage</strong></td>
