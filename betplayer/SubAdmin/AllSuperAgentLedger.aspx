<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SubAdmin/Dashboard.Master" CodeBehind="AllSuperAgentLedger.aspx.cs" Inherits="betplayer.SubAdmin.AllSuperAgentLedger" %>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="2" cellpadding="0" class="table table-striped table-hover table-bordered">
                                                                    <tbody>
                                                                        ...
                                                                        <% foreach (System.Data.DataRow row in PaynmentReceiveTable.Rows)
                                                                                            { %>
                                                                        <tr bgcolor="#E9F3FD">
                                                                            <td height="25" align="left" valign="middle" bgcolor="#FFFFFF" class="FontText"><%:row["AgentName"] %></td>
