...
namespace betplayer.SubAdmin
{
    public partial class CreateSuperAgent : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            {
                cn.Open();
                string Select = "Select * From SuperStockistMaster where ContactNo = @Contactno ";
                ...
                else
                {
                    ...
                    string update = "Update SuperStockistMaster Set Code = 'SS" + ID + "'where SuperStockistID = '" + ID + "' ";
                    MySqlCommand cmd1 = new MySqlCommand(update, cn);
                    cmd1.ExecuteNonQuery();


                    Response.Redirect("SuperStockistDetails.aspx?msg=Add");
                }
            }
        }
