<%@ Page Language="C#" MasterPageFile="~/SubAdmin/Dashboard.Master" AutoEventWireup="true" CodeBehind="UpdateSuperStokistlimit.aspx.cs" Inherits="betplayer.Subadmin.UpdateSuperStokistlimit" %>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">Superstockist Limit</h3>
                    <ul class="breadcrumb">
                        <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span> </li>
                        <li>Master Details <span class="divider">&nbsp;</span> </li>
                        <li>Superstockist Limit<span class="divider">&nbsp;</span></li>
                ...
                <div class="span12">
                    <div class="widget">
                        <div class="widget-title">
                            <h4><i class="icon-globe"></i>Superstockist Limit</h4>
                            ...
                            <table id="AgentLimitTable" width="100%" class="table table-striped table-hover table-bordered">
                                <tbody>
                                    ...
                                    <% int index = 2; foreach (System.Data.DataRow row in UpdateDataTable.Rows)
                                        { %>
                                    <tr bgcolor="#FFFFFF">
                                        <td height="25" align="left" class="FontText"><%: row["SuperStockistID"] %></td>
                                        <td align="left" class="FontText">
                                            <input name="ClientName1" type="text" class="TextBoxTransparent" id="ClientName1" style="text-align: right; text-align: left;" value="<%: row["SuperStockistID"] %><%: row["Name"] %>" readonly="">
                                        </td>
                                        ...
                                        <td align="left" class="TextBox100">
                                            <input id="AgentID" type="hidden" value="<%: row["SuperStockistID"] %>" />
                                    ...
                                    <tr bgcolor="#E9F3FD" class="TableHeading">
                                        ...
                                        <td align="left" valign="middle" bgcolor="#FFFFFF" class="TableHeading">
                                            <input runat="server" name="SuperstockistLimit" type="text" id="SuperstockistLimit" style="text-align: right" value=""></td>
    ...
    <script>
        ...
        function updateLimits() {
            ...
            for (var i = 1, row; i < (table.rows.length - 1); i++) {
                ...
                row = table.rows[i];
                var Fixchildren = row.cells[2].getElementsByTagName('input');
            ...
            fetch('/admin/superstokistLimit.ashx', {
                ...
                if (data.status === "success") {
                    ...
                    alert("please Check Superstockist Limit!!!")
                }
