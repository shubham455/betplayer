...
namespace betplayer.SubAdmin
{
    public partial class MatchSessionplusMinusSelect : System.Web.UI.Page
    {
        ...
        private DataTable Namedt;

        public DataTable SessionDatatable { get { return dt; } }
        public DataTable SuperAgentDatatable { get { return Namedt; } }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (MySqlConnection cn = new MySqlConnection(CN))
            {
                ...
                string s1 = "select Name,Code From AgentMaster";
        ...
        {
            int MatchID = Convert.ToInt32(Request.QueryString["MatchID"]);
            Response.Redirect("MatchSessionPlusminusDisplay.aspx?MatchID=" + MatchID);
        }
    }
}